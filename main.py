"""
PixelView - UI Shell (No Functionality Yet)
CMSC 162 - Project 1

This is a UI-only skeleton. Only the File menu is interactive (it opens a
dropdown). Every other control (Edit/View/Help, layer rows, Add Layer,
toolbar icons, info panel values) is a disabled placeholder that will be
wired up in later project phases.
"""
